        ...
        <table class="min-w-full border-collapse text-xs">
            <thead class="bg-yellow-200 text-gray-700">
                <tr>
                    ...
                    <th class="whitespace-nowrap border border-yellow-300 px-2 py-2 text-left">Result</th>
                    <th class="whitespace-nowrap border border-yellow-300 px-2 py-2 text-left">Reason</th>
            ...
            <tbody class="bg-yellow-50">
                ...
                <tr>
                    ...
                    <td class="border border-yellow-200 px-2 py-1">14025</td>
                    <td class="border border-yellow-200 px-2 py-1">2nd Floor</td>
                    <td class="border border-yellow-200 px-2 py-1">NOT FOUND</td>
                    <td class="border border-yellow-200 px-2 py-1">NO MATCH</td>
                    <td class="border border-yellow-200 px-2 py-1"></td>
                ...
                <tr>
                    <td colspan="14" class="border border-yellow-200 px-2 py-1 text-center text-gray-500">
