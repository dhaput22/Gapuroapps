...
<div class="space-y-4 text-[13px] text-gray-700">
    ...
    <div class="flex flex-wrap gap-2">
        <a href="{{ route('fg.storage.dispose.create') }}" class="rounded border border-yellow-500 bg-yellow-300 px-2 py-1 text-sm font-medium text-gray-800">
            Create FG Dispose
        </a>
    </div>
                ...
                <tr>
                    ...
                    <td class="border border-yellow-200 px-2 py-1 text-center">
                        <div class="flex items-center justify-center gap-1">
                            <a href="{{ route('fg.storage.dispose.edit', $scan) }}"
