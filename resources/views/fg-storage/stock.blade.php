...
<div class="space-y-4 text-[13px] text-gray-700">
    ...
    <form method="GET" action="{{ route('fg.storage.stock') }}" class="rounded border border-gray-200 bg-gray-100 px-4 py-3">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <div class="ml-3 text-xs text-gray-600">
                Total Qty Stock : <strong>{{ number_format($summary['total_qty'] ?? 0) }}</strong>
            </div>
        </div>
    </form>
