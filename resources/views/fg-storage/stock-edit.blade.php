...
<div class="space-y-4 text-[13px] text-gray-700">
    ...
    <h1 class="text-center text-2xl font-semibold text-gray-700">Edit FG Stock</h1>
    ...
    <form method="POST" action="{{ route('fg.storage.stock.update', $scan) }}" class="rounded border border-gray-200 bg-gray-50 px-6 py-5 max-w-xl">
        @csrf
        @method('PUT')
        ...
        <div class="mt-5 flex gap-2">
            ...
            <a href="{{ route('fg.storage.stock') }}" class="rounded border border-gray-300 bg-white px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                Batal
            </a>
        </div>
    </form>
